 ...
 *
*}
<a href="{$action.href}" class="btn btn-default" title="{$action.title}" {if $action.confirm == true }
	onclick="confirm_action('', '{$action.confirm_msg}', '{l s="Yes" js=1}', '{l s="No" js=1}', {$action.confirm_action}, {$action.cancel_action})"
		{/if}>
