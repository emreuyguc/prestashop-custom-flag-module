 ...
 *
*}
<div class="panel" id="{if isset($id)} {$id} {/if}">
	<div class="panel-heading">
		<i class="{if isset($icon)} {$icon} {/if}"></i>{if isset($title)} {$title} {/if}
        {if isset($content_header)} {$content_header} {/if}
	</div>

	<div class="panel-content panel-body">
        {if isset($content_body)} {$content_body} {/if}
	</div>


    {if isset($content_footer)}
		<div class="panel-footer">{$content_footer} </div>
	{/if}
